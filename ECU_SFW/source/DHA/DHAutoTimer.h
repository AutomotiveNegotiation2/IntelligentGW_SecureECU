#ifndef _DHAUTO_TIMER_H_
#define	_DHAUTO_TIMER_H_
...
enum 
{
	...
	STIMER_IOCTRL_CAN_LED_OP,
	STIMER_IOCTRL_CANFD_LED_OP,

	STIMER_IOCTRL_LIGHTING_GRILL_LED_OP,
#if 0
...
extern SoftTimerInfo SoftTimerTable[STIMER_END_OF_ID-1];
