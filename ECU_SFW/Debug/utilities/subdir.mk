...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__NEWLIB__ -I"D:\Work\Gateway\FW\NXP\ECU_NETIF\ECU_SFW\trunk\source" -I"D:\Work\Gateway\FW\NXP\ECU_NETIF\ECU_SFW\trunk\source\config" -g3 -gdwarf-4 -mcpu=cortex-m7 -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -D__NEWLIB__ -specs=nano.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
