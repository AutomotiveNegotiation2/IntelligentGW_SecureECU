...
C_SRCS += \
../bootutil_port/board_specific/flash_partitioning.c 

C_DEPS += \
./bootutil_port/board_specific/flash_partitioning.d 

OBJS += \
./bootutil_port/board_specific/flash_partitioning.o 


# Each subdirectory must supply rules for building sources it contributes
bootutil_port/board_specific/%.o: ../bootutil_port/board_specific/%.c bootutil_port/board_specific/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-bootutil_port-2f-board_specific

clean-bootutil_port-2f-board_specific:
	-$(RM) ./bootutil_port/board_specific/flash_partitioning.d ./bootutil_port/board_specific/flash_partitioning.o

.PHONY: clean-bootutil_port-2f-board_specific
