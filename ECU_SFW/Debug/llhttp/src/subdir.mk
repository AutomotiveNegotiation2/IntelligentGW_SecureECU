...
llhttp/src/%.o: ../llhttp/src/%.c llhttp/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-llhttp-2f-src

clean-llhttp-2f-src:
	-$(RM) ./llhttp/src/api.d ./llhttp/src/api.o ./llhttp/src/http.d ./llhttp/src/http.o ./llhttp/src/llhttp.d ./llhttp/src/llhttp.o

.PHONY: clean-llhttp-2f-src
