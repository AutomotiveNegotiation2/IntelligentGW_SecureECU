...
ifeq ($(RTOS),FREERTOS)
	...
	ifeq ($(SOC),j721s2)
		CSOURCES += j721s2_mcu2_1_mpu_cfg.c
		LINKER_CMD_FILES +=  $($(_MODULE)_SDIR)/j721s2_mcu2_1_freertos.lds
	endif
	ifeq ($(SOC),j784s4)
		CSOURCES += j784s4_mcu2_1_mpu_cfg.c
		LINKER_CMD_FILES +=  $($(_MODULE)_SDIR)/j784s4_mcu2_1_freertos.lds
	endif
endif
