...
#ifndef FFTLIB_LINALG_MATRIXMATRIXMULTIPLY_IXX_IXX_OXX_IDAT_H
#define FFTLIB_LINALG_MATRIXMATRIXMULTIPLY_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   ...
   uint32_t numReps;
   uint32_t testID;
} matrixMatrixMultiply_ixX_ixX_oxX_testParams_t;
...
#endif /* define FFTLIB_LINALG_MATRIXMATRIXMULTIPLY_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  FFTLIB_LINALG_matrixMatrixMultiply_ixX_ixX_oxX_idat.h                                     */
/* ======================================================================== */
