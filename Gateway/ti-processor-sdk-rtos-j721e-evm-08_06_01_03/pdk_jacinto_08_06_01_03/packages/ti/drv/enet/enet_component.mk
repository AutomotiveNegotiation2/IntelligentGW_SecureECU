...
drvenet_SOCLIST         = am65xx j721e j7200 j721s2 j784s4
drvenet_BOARDLIST       = am65xx_evm am65xx_idk j721e_evm j7200_evm j721s2_evm j784s4_evm
...
# are not enabled yet
drvenet_K3_SOCLIST      = am65xx j721e j7200 j721s2 j784s4
drvenet_K3_BOARDLIST    = am65xx_evm am65xx_idk j721e_evm j7200_evm j721s2_evm j784s4_evm

# List of cores where LwIP is supported (i.e. exclude A cores)
drvenet_lwip_CORELIST  = $(filter-out mpu1_0, ${drvenet_$(SOC)_CORELIST})

# List of cores where TimeSync test stack is supported
drvenet_timesync_am65xx_CORELIST = mcu1_0
drvenet_timesync_j721e_CORELIST  = mcu2_0
drvenet_timesync_j7200_CORELIST  = mcu2_0
drvenet_timesync_j721s2_CORELIST = mcu2_0
drvenet_timesync_j784s4_CORELIST = mcu2_0
...
#
# TimeSync demo - HAL library
#
export enet_timesync_hal_COMP_LIST = enet_timesync_hal
enet_timesync_hal_RELPATH = ti/drv/enet/examples/timesync/hal
enet_timesync_hal_PATH = $(PDK_ENET_COMP_PATH)/examples/timesync/hal
export enet_timesync_hal_LIBNAME = enet_timesync_hal
export enet_timesync_hal_LIBPATH = $(PDK_ENET_COMP_PATH)/lib
export enet_timesync_hal_MAKEFILE = -fmakefile
export enet_timesync_hal_BOARD_DEPENDENCY = no
export enet_timesync_hal_CORE_DEPENDENCY = no
export enet_timesync_hal_SOC_DEPENDENCY = yes
enet_timesync_hal_PKG_LIST = enet_timesync_hal
enet_timesync_hal_INCLUDE = $(enet_timesync_hal_PATH)
export enet_timesync_hal_SOCLIST = $(drvenet_SOCLIST)
export enet_timesync_hal_BOARDLIST = $(drvenet_BOARDLIST)
export enet_timesync_hal_$(SOC)_CORELIST = $(drvenet_timesync_$(SOC)_CORELIST)
enet_APP_LIB_LIST += enet_timesync_hal

#
# TimeSync demo - PTP library
#
export enet_timesync_ptp_COMP_LIST = enet_timesync_ptp
enet_timesync_ptp_RELPATH = ti/drv/enet/examples/timesync/protocol/ptp
enet_timesync_ptp_PATH = $(PDK_ENET_COMP_PATH)/examples/timesync/protocol/ptp
export enet_timesync_ptp_LIBNAME = enet_timesync_ptp
export enet_timesync_ptp_LIBPATH = $(PDK_ENET_COMP_PATH)/lib
export enet_timesync_ptp_MAKEFILE = -fmakefile
export enet_timesync_ptp_BOARD_DEPENDENCY = no
export enet_timesync_ptp_CORE_DEPENDENCY = no
export enet_timesync_ptp_SOC_DEPENDENCY = no
enet_timesync_ptp_PKG_LIST = enet_timesync_ptp
enet_timesync_ptp_INCLUDE = $(enet_timesync_ptp_PATH)
export enet_timesync_ptp_SOCLIST = $(drvenet_SOCLIST)
export enet_timesync_ptp_BOARDLIST = $(drvenet_BOARDLIST)
export enet_timesync_ptp_$(SOC)_CORELIST = $(drvenet_timesync_$(SOC)_CORELIST)
enet_APP_LIB_LIST += enet_timesync_ptp
