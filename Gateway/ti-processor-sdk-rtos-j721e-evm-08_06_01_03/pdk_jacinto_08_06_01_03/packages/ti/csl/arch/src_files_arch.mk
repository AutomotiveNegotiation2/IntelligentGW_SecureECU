...
ifeq ($(SOC),$(filter $(SOC), tda2xx tda2px dra75x tda2ex dra72x tda3xx am574x am572x am571x dra78x am64x am62x am62a am263x))
...
ifeq ($(SOC),$(filter $(SOC), am65xx am77x j7200 j721e j721s2 j784s4 tpr12 awr294x am64x am263x am62x am62a))
...
ifeq ($(SOC),$(filter $(SOC), am65xx am64x am62x am62a))
-include $(PDK_CSL_COMP_PATH)/arch/a53/src_files_a53.mk
endif

ifeq ($(SOC),$(filter $(SOC), j7200 j721e j721s2 j784s4 am77x))
