...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Matcher_object_5fdetection_2fprotos_2fmatcher_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_Matcher_object_5fdetection_2fprotos_2fmatcher_2eproto}, {
    ...
    case kArgmaxMatcher: {
      ...
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(
          1, _Internal::argmax_matcher(this), target, stream);
      break;
    }
    case kBipartiteMatcher: {
      target = stream->EnsureSpace(target);
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(
          2, _Internal::bipartite_matcher(this), target, stream);
      break;
    }
    default: ;
  }
