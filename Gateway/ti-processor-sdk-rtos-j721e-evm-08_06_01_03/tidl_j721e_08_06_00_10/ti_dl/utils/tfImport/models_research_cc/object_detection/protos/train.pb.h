...
class TrainConfig :
 ...
 public:
  ...
  void _internal_set_fine_tune_checkpoint(const std::string& value);
  ...
  void _internal_set_fine_tune_checkpoint_type(const std::string& value);
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 batch_queue_capacity() const;
  void set_batch_queue_capacity(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_batch_queue_threads() const;
  void set_num_batch_queue_threads(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 prefetch_queue_capacity() const;
  void set_prefetch_queue_capacity(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
...
inline ::object_detection::protos::PreprocessingStep* TrainConfig::add_data_augmentation_options() {
  ...
  return _internal_add_data_augmentation_options();
}
...
inline void TrainConfig::set_fine_tune_checkpoint(const std::string& value) {
  _internal_set_fine_tune_checkpoint(value);
...
inline std::string* TrainConfig::mutable_fine_tune_checkpoint() {
  ...
  return _internal_mutable_fine_tune_checkpoint();
}
...
inline void TrainConfig::set_fine_tune_checkpoint_type(const std::string& value) {
  _internal_set_fine_tune_checkpoint_type(value);
...
inline std::string* TrainConfig::mutable_fine_tune_checkpoint_type() {
  ...
  return _internal_mutable_fine_tune_checkpoint_type();
}
...
inline std::string* TrainConfig::add_update_trainable_variables() {
  ...
  return _internal_add_update_trainable_variables();
}
...
inline std::string* TrainConfig::add_freeze_variables() {
  ...
  return _internal_add_freeze_variables();
}
