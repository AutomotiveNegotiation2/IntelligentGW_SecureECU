...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MultiscaleAnchorGenerator_object_5fdetection_2fprotos_2fmultiscale_5fanchor_5fgenerator_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MultiscaleAnchorGenerator_object_5fdetection_2fprotos_2fmultiscale_5fanchor_5fgenerator_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::uint8* MultiscaleAnchorGenerator::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(3, this->_internal_anchor_scale(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_scales_per_octave(), target);
  }

  // optional bool normalize_coordinates = 6 [default = true];
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(6, this->_internal_normalize_coordinates(), target);
  }
