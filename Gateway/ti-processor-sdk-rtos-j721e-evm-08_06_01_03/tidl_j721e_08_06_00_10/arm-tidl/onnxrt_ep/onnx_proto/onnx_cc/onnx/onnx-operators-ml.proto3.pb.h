...
inline std::string* OperatorSetProto::release_ir_version_prerelease() {
  ...
  return ir_version_prerelease_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* OperatorSetProto::release_ir_build_metadata() {
  ...
  return ir_build_metadata_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
