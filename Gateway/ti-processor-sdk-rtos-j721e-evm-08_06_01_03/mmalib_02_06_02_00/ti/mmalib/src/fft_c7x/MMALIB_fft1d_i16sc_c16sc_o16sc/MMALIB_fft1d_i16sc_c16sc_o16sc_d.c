...
#include "MMALIB_fft1d_i16sc_c16sc_o16sc.h"
#include "MMALIB_fft1d_i16sc_c16sc_o16sc_cn.h"
...
#pragma DATA_SECTION(MMALIB_fft1d_i16sc_c16sc_o16sc_pBlock, ".pinit")
uint8_t MMALIB_fft1d_i16sc_c16sc_o16sc_pBlock
    [MMALIB_FFT1D_I16SC_C16SC_O16SC_PBLOCK_SIZE];
...
int MMALIB_fft1d_i16sc_c16sc_o16sc_d (uint32_t *pProfile,
                                             uint8_t   LevelOfFeedback)
{
   ...
   TI_profile_init ("MMALIB_fft1d_i16sc_c16sc_o16sc");
   ...
   for (tpi = 0; tpi < test_cases; tpi++) {
      ...
      if (pX && pY && pW && pXCn && pYCn && pShift) {
         ...
         status_opt = MMALIB_fft1d_i16sc_c16sc_o16sc_init (
             (int16_t *) pX,
             &bufParamsData,
             (int16_t *) pW,
             &bufParamsData,
             ...
             (uint32_t *) pShift,
             &bufParamsShift,
             MMALIB_fft1d_i16sc_c16sc_o16sc_pBlock);
         TI_profile_stop ();

         TI_profile_start (TI_PROFILE_KERNEL_OPT);
         status_opt = MMALIB_fft1d_i16sc_c16sc_o16sc_kernel (
             (int16_t *) pX,
             &bufParamsData,
             (int16_t *) pW,
             &bufParamsData,
...
not remove
         ...
         status_nat = MMALIB_fft1d_i16sc_c16sc_o16sc_cn ((int16_t *) pXCn,
                                                         &bufParamsData,
                                                         (int16_t *) pW,
                                                         &bufParamsData,
                                                         (int16_t *) pYCn,
         ...
         status_nat_vs_opt = TI_compare_mem (
             (void *) pY, (void *) pYCn, numPoints * 2 * sizeof (int16_t));
...
#endif //_HOST_BUILD
   {
      return MMALIB_fft1d_i16sc_c16sc_o16sc_d (&pProfile[0], 0);
   }
}
...
/* ======================================================================== */
/*  End of file:  MMALIB_fft1d_i16sc_c16sc_o16sc_d.c                        */
/* ======================================================================== */
