...
#define SKIP_SRC0_7504 0
#define SKIP_SRC1_7504 0 
...
int MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_d(uint32_t *pProfile, uint8_t LevelOfFeedback)
{
   ...
   /* Test Parameters */
   convolve_col_smallNo_ixX_ixX_oxX_testParams_t *prm;
   convolve_col_smallNo_ixX_ixX_oxX_testParams_t currPrm;
   convolve_col_smallNo_ixX_ixX_oxX_getTestParams(&prm, &test_cases);
      ...
      for(repCount = 0; repCount < numReps; repCount++){
...
#else
         void *src0                   = TI_memalign(MMALIB_ALIGN_128BYTES, 1);  // weights
#endif // #if SKIP_SRC0_7504 != 1
       ...
       if
            (src0 && src1 && dst && dst_cn)
         {
            ...
            status_init_opt = MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_init(handle,
                                                                               &src0_addr,
                                                                               &src1_addr,
                                                                               &dst_addr,
                                                                               &kerInitArgs);
            ...
            if(status_init_opt == MMALIB_SUCCESS){
               ...
               MMALIB_asm(" MARK 2");
               //               MMALIB_DEBUGPRINT_STACK_PTR;
               status_exec_opt = MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_exec(handle, src0, pSrc1, shiftValues, biasBValues, dst,
                                                                                  &kerExecInArgs,
                                                                                     &kerExecOutArgs_ci);
               MMALIB_asm(" MARK 3");
               TI_profile_stop();
               ...
               MMALIB_asm(" MARK 4");
               status_exec_opt = MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_exec(handle,
                                                                                  src0,
                                                                                  pSrc1,
                                                                                  shiftValues,
                                                                                  biasBValues,
            ...
            status_init_nat = MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_init(handle,
                                                                               &src0_addr,
                                                                               &src1_addr,
                                                                               &dst_addr,
                                                                               &kerInitArgs);
            ...
            if(status_init_nat == MMALIB_SUCCESS){
               kerExecInArgs.blockFeatureWidth = src1_addr.dim_x;
               status_exec_nat = MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_exec(handle,
                                                                                  src0,
                                                                                  pSrc1,
                                                                                  shiftValues,
                                                                                  biasBValues,
